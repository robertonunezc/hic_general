...
class HistoriaClinica(models.Model):
    ...
    nombre_madre = models.CharField(max_length=400)
    ocupacion_madre = models.CharField(max_length=400 ,null=True, blank=True)
    telefono_madre = models.CharField(max_length=400)
    nombre_padre = models.CharField(max_length=400)
    ocupacion_padre = models.CharField(max_length=400 ,null=True, blank=True)
    telefono_padre = models.CharField(max_length=400)
    estado_civil = models.CharField(max_length=400)
    escolaridad_menor = models.CharField(max_length=400)
    ...
    remitido_por = models.CharField(max_length=400)
    servicio_solicitado = models.CharField(max_length=400)
